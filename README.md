...
*PROYECCIÓN DE DATOS A ENTORNO BINARIO DONDE 1 CORRESPONDE A LA REINCIDENCIA EN MENOS DE 30 DÍAS Y 0 CORRESPONDE A >30 O NO REINCIDENCIA*
```r
...
*SEGMENTACIÓN DE DATOS POR TIPO DE ATENCIÓN MÉDICA*
